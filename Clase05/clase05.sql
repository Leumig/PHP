...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-09-2023 a las 01:41:14
...
(1002, '77900362', 'Spirit', 'solido', 45, 66.60, '2020-11-29', '2021-02-11'),
...
(1011, '77900311', 'Chocolate', 'solido', 50, 66.60, '2023-09-25', '2023-09-27');
...
--
ALTER TABLE `venta`
  ADD CONSTRAINT `venta_ibfk_1` FOREIGN KEY (`id_producto`) REFERENCES `producto` (`id`),
